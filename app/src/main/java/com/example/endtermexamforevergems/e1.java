...
public class e1   extends AppCompatActivity implements View.OnClickListener {
    ...
    public void ComputeResult() {
        ...
        if (checkboxone.isChecked()) {
            ...
            if (rawNumber >= 10) {
                double calc1 = (121 + addon) * rawNumber ;
                ...
                double result = 121 + addon * rawNumber;
                // Casted result to int type, remove to show decimal value
        ...
        if (checkboxtwo.isChecked()) {
            ...
            if (rawNumber >= 10) {
                double results = 121 + addon * rawNumber;
                double percentage = results * 10/100;
                double result = 121 + addon * rawNumber - percentage;
