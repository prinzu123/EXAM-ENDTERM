...
public class r1  extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r1layout);
    ...
    public void ComputeResult() {
        ...
        if (checkboxone.isChecked()) {
            ...
            if (rawNumber >= 10) {
                double calc1 = (1181 + addon) * rawNumber ;
                ...
                double result = 1181 + addon * rawNumber;
                // Casted result to int type, remove to show decimal value
        ...
        if (checkboxtwo.isChecked()) {
            ...
            if (rawNumber >= 10) {
                double results = 1181 + addon * rawNumber;
                double percentage = results * 10/100;
                double result = 1181 + addon * rawNumber - percentage;
