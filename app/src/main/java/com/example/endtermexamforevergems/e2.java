...
public class e2   extends AppCompatActivity implements View.OnClickListener {
    ...
    public void ComputeResult() {
        ...
        if (checkboxone.isChecked()) {
            ...
            if (rawNumber >= 10) {
                double calc1 = (33 + addon) * rawNumber ;
                ...
                double result = 33 + addon * rawNumber;
                // Casted result to int type, remove to show decimal value
        ...
        if (checkboxtwo.isChecked()) {
            ...
            if (rawNumber >= 10) {
                double results = 33 + addon * rawNumber;
                double percentage = results * 10/100;
                double result = 33 + addon * rawNumber - percentage;
