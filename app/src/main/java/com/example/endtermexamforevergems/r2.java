...
public class r2  extends AppCompatActivity implements View.OnClickListener {
    ...
    public void ComputeResult() {
        ...
        if (checkboxone.isChecked()) {
            ...
            if (rawNumber >= 10) {
                double calc1 = (34 + addon) * rawNumber ;
                ...
                double result = 34 + addon * rawNumber;
                // Casted result to int type, remove to show decimal value
        ...
        if (checkboxtwo.isChecked()) {
            ...
            if (rawNumber >= 10) {
                double results = 34 + addon * rawNumber;
                double percentage = results * 10/100;
                double result = 34 + addon * rawNumber - percentage;
